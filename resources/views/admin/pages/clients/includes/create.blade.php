<div id="modal" class="fixed inset-0 z-50 overflow-y-auto hidden" aria-labelledby="modal-title" role="dialog" aria-modal="true">
    <div class="flex min-h-screen items-end justify-center bg-black bg-opacity-25 px-4 pb-20 pt-4 text-center sm:block sm:p-0">
        ...
        <div class="relative inline-block transform overflow-hidden rounded-lg bg-white px-4 pb-4 pt-5 text-left align-bottom shadow-xl transition-all sm:my-8 sm:w-full sm:max-w-2xl sm:p-6 sm:align-middle">
            ...
            <form class="mt-4" id="addNewClientsForm" method="POST" enctype="multipart/form-data" action="{{ route('admin.pages.storeClients') }}">
                @csrf
                <div class="px-5 pb-5">
                    <input placeholder="Client Name" name="clientName" class="text-black placeholder-gray-600 w-full px-4 py-2.5 mt-2 text-base transition duration-500 ease-in-out transform border-transparent rounded-lg bg-gray-200 focus:border-blueGray-500 focus:bg-white dark:focus:bg-gray-800 focus:outline-none focus:shadow-outline focus:ring-2 ring-offset-current ring-offset-2 ring-gray-400">
                </div>
                 <div class="px-5 pb-5">
                ...
                <div class="px-5 pb-5">
                    ...
                    <select name="clientType" id="clientType" class="text-black w-full px-4 py-2.5 mt-2 text-base transition duration-500 ease-in-out transform border-transparent rounded-lg bg-gray-200 focus:border-blueGray-500 focus:bg-white dark:focus:bg-gray-800 focus:outline-none focus:shadow-outline focus:ring-2 ring-offset-current ring-offset-2 ring-gray-400">
...
<script>
    document.addEventListener('DOMContentLoaded', () => {
        ...
        const form = document.getElementById('addNewClientsForm');
        ...
        openClientModalBtn.addEventListener('click', openModal);
    ...
    fetch('{{ route("admin.pages.storeClients") }}', {
            method: 'POST',
            headers: {
