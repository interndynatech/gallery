        ...
        <div class="relative inline-block transform overflow-hidden rounded-lg bg-white px-4 pb-4 pt-5 text-left align-bottom shadow-xl transition-all sm:my-8 sm:w-full sm:max-w-2xl sm:p-6 sm:align-middle">
            ...
            <form class="mt-4" id="editCategoriesForm" method="POST" enctype="multipart/form-data">
                ...
                <div class="px-5 pb-5">
                    ...
                    <p class="text-teal-500 font-medium text-lg pt-4">Categories Title</p>
                    <input
                        id="categoryTitleDisplay"
                        name="title"
...
<script>
    document.addEventListener('DOMContentLoaded', () => {
            ...
            fetch(`/pages/show/${id}`)
                ...
                .then(data => {
                    if (data.error) {
                        ...
                        categoryTitleDisplay.value = data.categoriesTitle;
                        modalTitle.textContent = `Edit ${data.categoriesTitle}`;
        ...
        submitEditFormBtn.addEventListener('click', (event) => {
            ...
            fetch(`/pages/update/${currentCategoryId}`, {
                    method: 'POST',
                    headers: {
